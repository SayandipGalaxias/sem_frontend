...
export default function BackupScreen() {
    ...
    return (
        ...
        >
            <View style={{ marginBottom: 24, paddingBottom: 16, borderBottomWidth: 1, borderBottomColor: 'rgba(74,111,165,0.10)' }}>
                <Text style={{ fontSize: 24, fontWeight: '700' }} className="text-black dark:text-white">
                    Cloud Backup
                </Text>
                <Text style={{ fontSize: 13, color: '#8a93a6', marginTop: 4, lineHeight: 18 }}>
                    Secrets, contacts, and your encryption key are backed up to your private Google Drive folder. Auto-backup runs every hour.
                </Text>
            </View>
